...
export class UsersService {
     ...
     */
    public login(body?: LoginDTO, observe?: 'body', reportProgress?: boolean): Observable<string>;
    public login(body?: LoginDTO, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<string>>;
    public login(body?: LoginDTO, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<string>>;
    public login(body?: LoginDTO, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<string>('post',`${this.basePath}/api/Users/login`,
            {
                body: body,
